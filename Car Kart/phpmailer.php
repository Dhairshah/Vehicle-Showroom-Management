...
{
	$loginid 	= "hihi63539@gmail.com";
	$password 	= "akkikumar";
	$smtpserver = "smtp.gmail.com";
	$smtpport 	= 587;
	$mailsender = "VehicleShowroom";
	$companyname= "VehicleShowroom";
	$facebook = "https://www.facebook.com/vehicleshowroom";
	$twitter = "https://www.twitter.com/vehicleshowroom";
	$youtube = "https://www.youtube.com/vehicleshowroom";
	$linkedin = "https://www.linkedin.com/vehicleshowroom";
	$companyaddress  = "Online Vehicle Showroom, India";
	$contactno = "7042602381";
	$url = "www.vehicleshowroom.com";
